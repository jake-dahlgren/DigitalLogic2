...
# File: lab7.tcl
# Generated on: Tue Jan 31 13:45:40 2023
...
if {[is_project_open]} {
	if {[string compare $quartus(project) "lab7"]} {
		puts "Project lab7 is not open"
		set make_assignments 0
	}
} else {
	# Only open if not already open
	if {[project_exists lab7]} {
		project_open -revision lab7 lab7
	} else {
		project_new -revision lab7 lab7
	}
...
if {$make_assignments} {
	...
	set_global_assignment -name PROJECT_CREATION_TIME_DATE "11:38:10  JANUARY 31, 2023"
